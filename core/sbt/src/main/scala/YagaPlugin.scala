...
object YagaPlugin extends AutoPlugin {
  ...
  object autoImport {
    ...
    val yagaGeneratedResources = taskKey[Seq[File]]("Resources generated by yaga")
  ...
  override def projectSettings: Seq[Setting[_]] = Seq(
    ...
    yagaGeneratedResources := Seq.empty,
    Compile / resourceGenerators += yagaGeneratedResources,
  )
}
